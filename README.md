...
Download the project from github and unzip the file or You can clone the project using the github link [https://github.com/bamsi/leaderboard.git]
...
This is a very beginning of the leaderboard which shows the structure of the website.
